...
int srsran_ue_dl_init_emul(srsran_ue_dl_t* q, cf_t* input[SRSRAN_MAX_PORTS], uint32_t max_prb, uint32_t nof_rx_antennas, const char* params_filename); // whko 08312023
