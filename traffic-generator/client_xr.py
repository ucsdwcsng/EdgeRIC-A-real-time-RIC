    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        ...
        try:
            while True:
                ...
                s.sendall(data)
                print(f"Sent {packet_size} bytes of data for xr")
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--packet-size', type=int, default=9535, help='Packet Size in Bytes')
    parser.add_argument('--packet-size', type=int, default=2000, help='Packet Size in Bytes')
